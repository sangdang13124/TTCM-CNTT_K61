...
_autoSprites =false;
if sprite_index !=sSuperAttackSkill1
{
	sprite_index = sSuperAttackSkill1;
	image_index =0;
}
if sprite_index==sSuperAttackSkill1 && floor(image_index)== attackFrame && !attackTriggered
{
...
///giu hoat anh
if sprite_index == sSuperAttackSkill1 && floor(image_index) == holdFrame
{
	holdTimer --;
	if holdTimer > 0
	{
...
if sprite_index != sSuperAttackSkill1{attackTriggered=false;holdTimer=holdTime};
